...
<body> 
    ...
    <div class="incio1 darken text">
        <div class="topnav" id="myTopnav">
            <div class="width80">
                ...
                <a style="color:red;"  href="inicio">INCIO</a>
        ...
        <div class="wrapperincio1_message">
            ...
            <?php if(isset($_SESSION['tu'])): ?>
                ...
                <?php else:?>
                     <a href="menu"><button>VER MENU HOY</button></a>
                <?php endif; ?>
            <?php else: ?>
                    <a href="menu"><button>VER MENU HOY</button></a>
            <?php endif; ?> 
    ...
    <div class="middle1">
             ...
             <table class="special"  align="center">      
                <tr>
                    <td rowspan="2"><img  src="resources/story1.png" align="right" class="side"></td>
                    <td >
                        <div class="blockcontentwrapper">
                            <div class="inlineblockcontent">
                                <p>Los origenes se remontan al 10 de junio de 1960, cuando Ibrahim Mata  compraron la Hamburguesa "Soy Yo" con una  inversion inicial de 950 dolares. El local estaba situado en Lecheria, y la idea de Ibrahim era vender Hamburguesas a domicilio a las personas de las residencias cercanas. Aquella experiencia no marchaba como tenían previsto.</p>
                            </div> 
                            <div class="inlineblockcontent">
                                <p>A pesar de todo, Ibrahim se mantuvo al frente del restaurante y tomo decisiones importantes para su futuro, como reducir la carta de productos y establecer un reparto a domicilio gratuito. Después de adquirir dos restaurantes mas en Barcelona, en 1965 renombro sus tres locales como Ibra's Burger Grill.</p>
                            </div>
                        </div>
                    </td>
                    <td rowspan="2"><img  src="resources/story2.png" align="left" class="side1"></td>
                </tr>
            </table>
    </div>

    <div id="navhash">
        <div class="middleiwrapper">
...
<script type="text/javascript">
    ...
    {  
        ...
        bt=document.getElementById("bt1").value;    
        bp=document.getElementById("pburger1").value;   
        rp=document.getElementById("rp1").value;
    ...
    {  
        ...
        document.getElementById("bidf").value=x; 
    }
    function constructmi2(x)
    {  
        if (window.confirm("Do you really want to Delete?")) { 
          window.open("deleteburger?bid="+x,'_self');
        } 
    }
</script>
    ...
    <div id="popup1" class="overlay">
        <div class="popup1">
            ...
            <div class="content">
                ...
                <br><br>
                <span style="color:black">Price : </span>
                <input type="number" name="pburger" id="pburger1">
                <br><br>
                <span style="color:black">Bread Type : </span>
                <input type="text" name="bt" id="bt1">
                <br><br>
                <span style="color:black">Recipes : </span>
                <textarea name="rp" id="rp1" rows="4"></textarea>
                <br><br>
                <span style="color:black">Image:</span>
                <input style="color:black;" type="file" name="fileToUpload" id="fileToUpload1" >
                <br><br> 

<?php 
        ob_start();
	?> @include('sessioncheck.index') <?php
	$s=ret_session();
	$user=explode(",",$s);  
...
<body> 
	...
	<div id="mySidenav" class="sidenav">
	  ...
	  <a href="editpassword_admin"  style="color:red;" class="tl">Change password</a>
	...
	<div class="middlewrapper">
			...
			<form class="form1" id="form1" onsubmit="return form1()" action="changeap" method="post" >
			{{csrf_field()}}
		 	<div class="row"> 
		      <div class="col-75">
